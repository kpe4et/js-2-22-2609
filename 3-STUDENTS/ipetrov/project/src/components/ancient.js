export default class ancientParent {
    constructor(url = '/basket.json', container = '#basket') {
        ...
        this._init();
        // this.basket = basket; // !!!!!c only
        // this.shown = false; // !!!!!!!!!b only
        // this.itemsContainer = document.querySelector('#basket-items'); // !!!!b only
    }
    ...
    // _handleActions() { // для каждого класса свой
    ...
    // _render() { чорд его знает, надо всем. но разное
    //     let str = '';
